const Introduction = () => {
    ...
    return (
        <div className="flex flex-col">
            <h1 className="text-black font-bold text-4xl">Exclusivo: Gotas com Extratos de Raízes e Colageno UC2 podem acabar com dores em poucos dias</h1>
            <h3 className="text-zinc-500 text-xl my-6">
                Solução natural para quem sofre com dores no corpo, artrite, artrose, reumatismo, fibromialgia e etc.
            </h3>
            <div className="flex flex-col">
                <span>02/07/2023 16h58 | Atualizado em: {currentDate}</span>
